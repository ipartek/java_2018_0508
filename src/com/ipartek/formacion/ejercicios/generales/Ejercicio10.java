...
/**
 * El programa para pasar un número expresado en binario a decimal se basa en la
 * forma tradicional de hacerlo. Los dígitos del número binario ocupan una
 * posición que se numera de derecha a izquierda empezando por cero. La posición
 * del dígito más a la derecha es la 0.
 *
 */
