...
/**Escribe un programa Java que realice lo siguiente: declarar una variable <b>n</b> de tipo int, una variable <b>a</b> de tipo double y <br>
 * una variable <b>c</b> de tipo char y asigna a cada una un valor. A continuación muestra por pantalla:<br>
 ...
 *  Si por ejemplo le hemos dado a N el valor 5, a A el valor 4.56 y a C el valor ‘a’, se debe mostrar por pantalla:<br>
