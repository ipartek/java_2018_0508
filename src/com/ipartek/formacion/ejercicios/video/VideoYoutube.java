...
public class VideoYoutube {
	...
	private static void cargarVideos() {
		Youtube video = new Youtube(12650, "Nightmares On Wax Boiler Room London DJ Set", "Q692lHFaLVM");
		dao.insert(video);
		
		video = new Youtube(701, "The Skatalites - Rock Fort Rock", "6bLVdKbPHHY");
		dao.insert(video);
	...
	private static void pintarMenu() {
		...
		try {
			...
			sc.nextLine();
			System.out.println("Opcion no valida por favor introduce un numero");
			pintarMenu();
		}
