 ...
 * Supondremos que el texto solo contiene letras mayúsculas o minúsculas. La letras serán las correspondientes al alfabeto inglés.
 * En este método de cifrado cada letra del texto se sustituye por otra letra que se encuentra N posiciones 
 * delante en el alfabeto. Se considera que el alfabeto es circular, es decir, la letra siguiente a la ‘z’ es la ‘a’.
 */
