 ...
 * 
 * Si queremo convertir el número 12 en binario haremos las siguientes
 * operaciones:
 * 
 * 
 * 
 ...
 * 
 * 
 * Este ejercicio se suele plantear cuando se está comenzando a aprender las
 * estructuras repetitivas (while, for, do while) y aún no se conocen los arrays
 * por lo que la solución que se plantea no utiliza arrays y por tanto esta
 * solución aunque es correcta solo es válida para números enteros relativamente
 * pequeños.
 * 
 * 
 * @author Ainara
