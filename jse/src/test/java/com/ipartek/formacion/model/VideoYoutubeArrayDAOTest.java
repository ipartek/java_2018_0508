...
public class VideoYoutubeArrayDAOTest {
	...
	public void testGetById() {
		...
		assertNull("No deber�a encontarar este id -1", dao.getById(ID_INEXISTENTE));
	...
	public void testUpdate() {
		...
		VideoYoutube videoModificarSinId = new VideoYoutube(ID_INEXISTENTE, "Canci�n inexistente", "fff");
