...
public class ArrayListTest {
	...
	public void test() {
		...
		assertTrue(paises.isEmpty()); //comprobar que la lista esta vac�a
		...
		assertEquals("Italia",paises.get(0)); //buscar, espa�a se ha ido y ahora italia esta en la posicion 0
