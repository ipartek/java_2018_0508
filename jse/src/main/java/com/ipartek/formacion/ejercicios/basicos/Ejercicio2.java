...
/**
 * Escribe un programa Java que realice lo siguiente: declarar dos variables
 * <b>x</x> e <b>y</> de tipo int, <br>
 * dos variables <b>n</b> y <b>m</b> de tipo double y asigna a cada una un
 ...
 * y a N el valor 4.7 se debe mostrar por pantalla:<br>
 * Variable X = 1<br>
 * Variable Y = 2<br>
 * Variable M = 3.2<br>
 * Variable N = 4.7<br>
