...
/**
 * Escribe un programa java que declare una variable <b>a</b> de tipo entero y
 * asígnale un valor. A continuación muestra un <br>
 * mensaje indicando si <b>a</b> es par o impar. Utiliza el operador condicional
 * ( ? : ) dentro del println para resolverlo.<br>
