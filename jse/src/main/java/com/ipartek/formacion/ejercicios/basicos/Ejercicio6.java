...
/**
 * 
 * Escribe un programa java que declare una variable <b>b</b> de tipo entero y
 * asígnale un valor. A continuación muestra un <br>
 * mensaje indicando si el valor de B es positivo o negativo. Consideraremos el
 * 0 como positivo. Utiliza el operador <br>
