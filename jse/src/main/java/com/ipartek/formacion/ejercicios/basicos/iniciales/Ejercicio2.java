...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("OPERACIONES CON INT Y DOUBLE ");
		System.out.println("x+n="+(x+n));
		System.out.println("y/m="+(y/m));
		System.out.println("y%m="+(y%m));
	    System.out.println("Variable x="+x+" el doble es"+2*y);
	    System.out.println("Variable y="+y+" el doble es"+2*y);
	    System.out.println("Variable m="+m+" el doble es"+2*m);
	    System.out.println("Variable y="+n+" el doble es"+2*n);
	    System.out.println("Suma de todas las variables"+(x+y+m+n));
