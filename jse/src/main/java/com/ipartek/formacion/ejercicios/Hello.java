...
public class Hello {
	...
	public static void main(String[] args) {
		...
		//String[] alumnos = { "Eneko Mu�oz", "joseba", "Adrian P","Ainara", "Asier", "Adrian G", " Raul", "Luis", "Guillermo", "Carlos",
		//		"Eneko Sanchez","Adriana", "Andrea", "Valeria", "Alain" };

		Person[] alumnos = new Person[15];
		
		Person p = new Person("Raquel" , "Pastor", Person.SEXO_HOMBRE );
		alumnos[0] = p;
		...
		p = new Person("Alain" , "Mu�oz", Person.SEXO_HOMBRE );
		alumnos[13] = p;
