...
/**
 * Programa Java que lea por teclado 10 n�meros enteros y los guarde en un array. 
 * A continuaci�n calcula y muestra por separado la media de los valores positivos 
