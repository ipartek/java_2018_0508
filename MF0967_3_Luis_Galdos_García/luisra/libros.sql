...
INSERT INTO `alumno` VALUES (11,'CaraAntxoa'),(1,'DrohneT'),(8,'el fary'),(6,'Fary puto amo'),(9,'fuckU'),(12,'Javier '),(5,'Luis2'),(3,'Raul');
...
INSERT INTO `editorial` VALUES (1,'anaya'),(2,'estudiate'),(3,'santillana');
...
INSERT INTO `libro` VALUES (4,'Libro gordo de petete','asd',1),(5,'Libro gordo de petete','asd',1),(6,'Libro gordo de petete','asd',1),(7,'Libro gordo de petete','asd',1),(8,'prueba Modificada','zxc',1);
...
CREATE TABLE `prestamo` (
  ...
  PRIMARY KEY (`id_alumno`,`id_libro`,`fecha_inicio`),
  KEY `fk_alumno_has_libro_libro1_idx` (`id_libro`),
  KEY `fk_alumno_has_libro_alumno1_idx` (`id_alumno`),
  CONSTRAINT `fk_alumno_has_libro_alumno1` FOREIGN KEY (`id_alumno`) REFERENCES `alumno` (`idalumno`),
  CONSTRAINT `fk_alumno_has_libro_libro1` FOREIGN KEY (`id_libro`) REFERENCES `libro` (`idlibro`)
...
BEGIN
DELETE FROM editorial WHERE id = p_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
SELECT idlibro, titulo, isbn,  id_editorial FROM libro WHERE idlibro = p_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2018-10-25 18:26:06