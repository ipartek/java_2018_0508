...
public class VideoDAO implements Crudable<Video> {
	...
	private final String SQL_GET_ALL = "SELECT id,codigo,nombre,id_usuario FROM video ORDER BY id DESC LIMIT 1000;";
	private final String SQL_GET_BY_ID = "SELECT id, codigo, nombre,id_usuario FROM video WHERE id = ? LIMIT 1000;";
