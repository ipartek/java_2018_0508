<%@include file="includes/header.jsp" %>
	...
	<div class="container mt-3">
		...
		<div class="row">
			<div class="col-lg-3"></div>
			<div class="col-lg-3">
				<i class="fas fa-arrow-left float-left mb-2"><a href="inicio"> Anterior</a></i>
			</div>
			<div class="col-lg-3">
				<i class="fas fa-arrow-right float-right mb-2"><a href="inicio" class="float-left mr-1">Siguiente </a></i>
			</div>
			<div class="col-lg-3"></div>
		</div>
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="card">
				  <div class="card-body">
				    <h2 class="text-center">Pagina 1/10</h2>
				    <p>Erase una vez...</p>
				  </div>
		...
		<div class="row mb-3">
			<div class="col-lg-3"></div>
			<div class="col-lg-3">
				<i class="fas fa-arrow-left float-left mt-2"><a href="inicio"> Anterior</a></i>
			</div>
			<div class="col-lg-3">
				<i class="fas fa-arrow-right float-right mt-2"><a href="inicio" class="float-left mr-1">Siguiente</a></i>
			</div>
			<div class="col-lg-3"></div>
		</div>
	</div>
