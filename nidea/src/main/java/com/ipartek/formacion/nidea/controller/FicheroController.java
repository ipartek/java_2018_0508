...
public class FicheroController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("*******doGet-FicheroControlelr********");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
	        ...
	        for (Part part : request.getParts()) {
	            ...
	            request.setAttribute("alert", new Alerts(Alerts.SUCESS, mensaje.toString() ));
	        }
	        
	       
		}catch (Exception e) {
			request.setAttribute("alert", new Alerts(Alerts.DANGER, e.getMessage() ));
		}  finally {
