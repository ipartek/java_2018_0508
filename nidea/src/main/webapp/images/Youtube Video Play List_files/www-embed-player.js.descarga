...
function Be(a,b){var c=P("XSRF_FIELD_NAME",void 0),d=P("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.C,g=Q("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.kb||nc(H(a)[3]||null)&&!b.withCredentials&&nc(H(a)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.C&&b.C[g]||(f||(f={}),f[c]=d);f&&t(e)&&(e=re(e),mb(e,f),e=b.ka&&"JSON"==b.ka?JSON.stringify(e):pc(e));f=e||f&&!hb(f);!ve&&f&&"POST"!=b.method&&(ve=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
;function og(a,b){var c={"X-Goog-Visitor-Id":P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return c;var d;a?d="Bearer "+w("gapi.auth.getToken")().gb:d=Jc([]);d&&(c.Authorization=d,c["X-Goog-AuthUser"]=P("SESSION_INDEX",0),S("pageid_as_header_web")&&(c["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return c}
...
n(Pg,J);Pg.prototype.l=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.ib)}J.prototype.l.call(this)};var Qg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Rg(a){a=a||"";if(window.spf){var b=a.match(Qg);spf.style.load(a,b?b[1]:"",void 0)}else Sg(a)}
