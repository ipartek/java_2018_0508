...
CREATE TABLE `video` (
  ...
  CONSTRAINT `video_has_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `categoria` (`idcategoria`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-11-20 12:26:00
