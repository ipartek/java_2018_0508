        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            %>      
	          ...
	          <span id="logeado"><i class="fas fa-user"></i> <%=usuario.getNombre() %></span>
        ...
        <div class="col-lg-3">        	
          ...
          <ul class="list-group">
          	<%
          		...
          		ArrayList<Video> videosReproducidos = (ArrayList<Video>) request.getAttribute("videosReproducidos");
          		if ( videos == null ){
            ...
            <%
          	...
          	%>
          			<li class="list-group-item d-flex justify-content-between align-items-center">     
		          	  	<p>Por favor, Inicia Sesión para guardar tus videos reproducidos</p>
		            </li>
          	<%
          		}
            %>
