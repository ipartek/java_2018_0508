...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        ...
        <a class="navbar-brand" href="#"><fmt:message key="lista.repr"></fmt:message></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <c:if test="${not empty sessionScope.usuario}">
	            ...
	            <div class="nav-user"><i class="fas fa-user mr-2"></i><span class="text-white">${sessionScope.usuario.nombre}</span>
            ...
            <c:if test="${empty sessionScope.usuario}"> 
				...
				<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal-login-form">Open Modal</button>
