      	...
      	<div class="col-6">	
      		...
      		<form method="post" action="registro">
      		 	<div class="form-group">
	      			<input type="text" onblur="checkNombre()" name="nombre" id="nombre" class="form-control" placeholder="Dime Tu nombre,min 3 maximo 50 letras" required autofocus pattern=".{3,50}">
