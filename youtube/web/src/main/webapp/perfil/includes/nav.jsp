            ...
            <div class="navbar-default sidebar col-lg-3" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="inicio" class="dashboard"><i class="fas fa-home"></i> Mi perfil</a>
                        </li>
                        
                        <li>
                            <a href="usuarios"><i class="fas fa-comments"></i> Mis Comentarios</a>
                        </li>
                        
                        <li>
                            <a href="videos" class="video"><i class="fab fa-youtube"></i> Mis Videos</a>
