         ...
         <li class="nav-item active">
		         ...
		         <c:if test="${empty sessionScope.usuario}">
		            ...
		            <form action="login" method="post" class="form-inline mt-2 mt-md-0">
		           		...
		           		<input type="checkbox" name="recuerdame" ${(not empty cookie.cNombre.value)?"checked":""} class="ml-2">		           		 
		           		<button class="btn btn-outline-info my-2 my-sm-0 ml-2" type="submit">Entrar</button>
		         	</form>
		         	
		         	<li>
		         		<a href="registro.jsp" class="btn btn-outline-info my-2 my-sm-0 ml-2">Registrate</a>
		         	</li>
