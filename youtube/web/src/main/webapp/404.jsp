...
<html lang="ES">
  ...
  <body>
    ...
    <div class="error"> 
        ...
        <hr>
		<h6>La página a la que deseas acceder no existe en el servidor. <br>
		Si lo desea pongase en contacto con el <a href="mailto:example@email.com">Servicio Técnico</a> para informar del error.</h6>
		<hr>
