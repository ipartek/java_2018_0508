package com.ipartek.formacion.gestion.model;
...
//		// assertTrue("Beberia haber insertado usuario MOCK", serviceUsuario.crear(uMock));
//
//	}
//
//	@After
...
//		assertEquals("comporbar rol tipo usuario", Rol.ROL_USER, uMock.getRol().getId());
//		
//		//validaciones
...
//			fail("deberia lanzar Exeption, usuario repetido");
//		} catch (Exception e) {
//			assertTrue(true);
//		}
//
