...
//we can also use <body onload=mifuncion()> or $(document).ready()
...
function registerEventsListener(){
	//Adds an event when a key is pressed and when u stops holding it
	...
	btn_play.addEventListener("click", draw, false);
}
