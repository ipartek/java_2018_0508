...
public class LibroDAO implements CrudAble<Libro> {
	...
	/*
	 * public List<Libro> getAllPrestados( boolean isPrestados) { ArrayList<Libro>
	 * resul = new ArrayList<Libro>(); for(Libro libro : libros) {
	 * if(libro.isPrestado()== isPrestados) { resul.add(libro); } } return resul; }
	 */
	/**
	 * Lisbros que coincida el titulo, es ignoreCase, nos sirve cualquier
	 * coincidencia
	 * 
	 ...
	 * 
	 * ArrayList<Libro> resul = new ArrayList<Libro>(); if(busqueda != null) {
