		...
		<td>
			<form action="conversor" method="post">
				...
				<input type="hidden" name="formulario"
					value="<%=ConversorController.FORM1%>"> <input id="boton"
					type="submit" value="Convertir">
			</form>
		</td>
		<td>
			<form action="conversor" method="post">
				<label for="unidad">Pies</label>
				<input name="pies" type="text">
				<p style="color: green">La conversion a metros es:
					${conversorpies }</p>
				<p style="color: red">${msgpies }</p>
				<p style="color: red">${msg }</p>
				<input type="hidden" name="formulario"
					value="<%=ConversorController.FORM2%>"> <input id="boton"
					type="submit" value="Convertir">
			</form>
		</td>
	</tr>
