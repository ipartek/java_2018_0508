			...
			<c:forEach items="${productos}" var = "producto">
		        <div class="producto">
	                ...
	                <div class="texto-producto">
	                    ...
	                    <p>
	                    	<span class="${producto.descuento<=0?'invisible':'tachado'}">${producto.calcularDescuento	}&euro;</span>
	                    	<span clasS="${ producto.descuento<=0?'no-descuento':''}">${producto.precio}&euro;</span>
	                    </p>
