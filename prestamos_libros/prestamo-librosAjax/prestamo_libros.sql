...
INSERT INTO `alumno` VALUES (1,'adrian','garcia'),(2,'asier','cornejo'),(3,'andrea','gartiburu'),(5,'jonan','lopez'),(6,'alex','madinabeitia'),(7,'irene','de la fuente'),(9,'Marcos','Domingo');
...
INSERT INTO `libro` VALUES (1,'html5','978-3-16-148410-0',1),(2,'css3','1-4028-9462-7',2),(3,'java EE','978-1-4028-9462-6',4),(4,'mysql','925-5-2482-4900-0',2);
...
INSERT INTO `prestado` VALUES (1,2,'2018-10-22 13:52:52',NULL),(2,1,'2018-10-22 13:52:52',NULL),(4,5,'2018-10-22 13:52:52',NULL);
...
INSERT INTO `tipo_editorial` VALUES (1,'Anaya'),(32,'dfefe'),(19,'edvf'),(4,'Moreno'),(18,'njehvder3333333'),(15,'Pakito '),(13,'prueba_3'),(3,'Rubio'),(2,'Santillana');
...
BEGIN
SELECT l.id, l.titulo, l.isbn, l.id_tipo_editorial, te.editorial FROM libro as l, tipo_editorial as te WHERE l.id_tipo_editorial = te.id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2018-10-25  8:36:20
