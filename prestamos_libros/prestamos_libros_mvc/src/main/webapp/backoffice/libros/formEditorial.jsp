               ...
               <input type="hidden" name="id" value="${editorial.id}">
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="frist_name" type="text" class="form-control" name="nombre" value="${editorial.nombre}" required autofocus>
                    </div>
                  </div> 
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block">Añadir Editorial</button>
                  </div>
                </form>
              </div>
            </div>
