...
<script>
	...
	function showModalModificar(id, id_alumno, id_libro, fecha_inicio) {

		console.log('showModalModificar id=' + id + ' id_alumno=' + id_alumno
				+ ' id_libro=' + id_libro + ' fecha_inicio=' + fecha_inicio);
