...
public class LibrosController {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Mostrar lista de libros correctamente", responseContainer = "List") })
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Mostrar detalle libro correctamente", responseContainer = "Libro"),
	...
	@ApiResponses(value = {
			@ApiResponse(code = 201, message = "Crear un libro correctamente", responseContainer = "Editorial"),
		...
		try {
			...
			if (violations.isEmpty()) {
				...
				if (servicePrestamo.prestar(prestamo/*
													 * prestamo.getLibro().getId(), prestamo.getAlumno().getId(),
