...
public class AlumnosController {
	...
	public AlumnosController() {
		...
		LOG.trace("Servicios alumnos instanciados");
	}
...
// sacar que produce model
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Alumno Creado"),
			@ApiResponse(code = 409, message = "<ol><li>No cumple validaciones</li><li>Nombre alumno ya existe</li></ol>") })
	...
	@ApiOperation(value = "Modificar Alumno", response = Usuario.class)
	@ApiResponses(value = { @ApiResponse(code = 201, message = "Modificar Alumno"),
			@ApiResponse(code = 404, message = "No se encontro Alumno"),
			@ApiResponse(code = 409, message = "<ol><li>El nombre del alumno no puede estar repetido</li> <li>No cumple validaciones</li></ol>") })
