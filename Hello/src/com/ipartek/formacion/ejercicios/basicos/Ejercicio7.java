...
/**
 * Escribe un programa java que declare una variable <b>c</b> de tipo entero y asígnale un valor. A continuación muestra un <br>
 * mensaje indicando si el valor de <b>c</b> es positivo o negativo, si es par o impar, si es múltiplo de 5, si es múltiplo de<br>
 *  10 y si es mayor o menor que 100. Consideraremos el 0 como positivo. Utiliza el operador condicional ( ? : ) dentro del <br>
