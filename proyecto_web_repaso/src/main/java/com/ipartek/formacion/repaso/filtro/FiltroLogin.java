 ...
 * 
 */
@WebFilter(dispatcherTypes = { DispatcherType.REQUEST }, urlPatterns = { "/videojuego" }) // TODO COMPROBAR ROL DEL
																							// USUARIO
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		try {
			...
			if (usuario != null && !usuario.equals("0")) {
				...
				res.sendRedirect("videojuego");

			} else {
				session.setAttribute("clase", "btn btn-danger");
				/*
