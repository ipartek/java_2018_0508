...
public class ComentarioController extends HttpServlet {
	...
	private ComentarioArrayDAO comentarioDAO;
	...
	public void init(ServletConfig config) throws ServletException {
		super.init(config);
		comentarioDAO = ComentarioArrayDAO.getInstance();
	}
	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(comentarioDAO.insert(comentario)) {
				alert = new Alert(Alert.ALERT_SUCCESS, "Gracias por escribir un comentario. Está pendiente de moderación.");
			}else {
