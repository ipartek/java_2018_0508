	  ...
	  <div class="row">
	    <div class="span12">
	      <div class="hero-unit center">
	          <h1>La página no existe <small><font face="Tahoma" color="red">Error 404</font></small></h1>
	          <br />
	          <p>Parece que la página a la que intentas acceder no existe. 
	          Actualmente esta página web no puede mostrarse. Esto puede significar que la página no exista o se haya borrado.</p>
